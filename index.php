			...
			<div class="carousel-inner">
				<div class="item active">
					...
					<div class="carousel-caption">
						<h2>Register for Quizzonance v2.0</h2>
						<h4>Prelims going on</h4>
						<a href="http://goo.gl/forms/OzTpF2W4E7" target="_blank">Register Here <i class="fa fa-angle-right"></i></a>
					</div>
				</div>
				<div class="item">
	...
	<section id="history" style="background: #C34C39;">
        <div class="container">
                        ...
                        <li>
                            ...
                            <div class="timeline-panel">
                                ...
                                <div class="timeline-body">
                                    <p class="text-muted" style="color: #fff;">This is the first intra college quiz of each year involving only first year students. The aim of this event is to develop the interest of the first years in the activities of our club. Siz qualifying teams from the rpelims make it to the finals. Thw winning team is considered for free induction into the club.</p>
                                </div>
                            </div>
                        </li>
			...
			<li class="timeline">
                            ...
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4 style="color: #fff;">March 2016</h4>
                                    <h4 class="subheading" style="color: #fff;">Quizzonance v2.0</h4>
                                </div>
                                <div class="timeline-body">
                                    <p class="text-muted" style="color: #fff;">Another interesting quiz. The second version of their event, we saw rgeater participation this time.</p>
                                </div>
                            </div>
                        </li>
                        <li class="timeline-inverted">
				...
				<div class="row">
					<div class="col-sm-3 col-sm-offset-4">
						<div class="contact-text">
							<h3>Contact</h3>
							<address>
								E-mail: mail2msitgnsis@gmail.com<br>
							</address>
						</div>
